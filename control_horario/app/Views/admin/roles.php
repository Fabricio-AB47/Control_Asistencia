...
<main class="main-control">
  <div class="container">
    ...
    <form method="post" action="<?= $base ?>/index.php?r=admin&action=roles_create" class="registro-formulario" style="margin-bottom:1rem;">
      ...
      <div class="registro-botones" style="grid-column:1 / -1;">
        ...
        <a class="registro-btn volver" href="<?= $base ?>/index.php?r=dashboard&mod=admin">Volver al dashboard</a>
      </div>
    </form>
