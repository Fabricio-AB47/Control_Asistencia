...
<header class="header">
  ...
  <nav class="contenedor-menu">
    <h2>Menú</h2>
    <a href="../academico/dashboard.php">Inicio</a>
...
(function(){
  ...
  const ENDPOINTS = {
    ingreso:         '../academico/registrar_ingreso.php',
    salidaAlmuerzo:  '../academico/registrar_salida_almuerzo.php',
    regresoAlmuerzo: '../academico/registrar_regreso_almuerzo.php',
    salidaLaboral:   '../academico/registrar_salida_laboral.php'
  };

  // ✅ Siempre redirige al dashboard TI tras cada registro exitoso
  const REDIR = '../academico/dashboard.php';
