...
if ($latitud === null || $longitud === null || !$direccion) {
    ...
    echo "<script>setTimeout(function(){location.href='../academico/dashboard.php';},2000);</script>";
    exit();
}
...
try {
    ...
    echo "<script>setTimeout(function(){location.href='../academico/dashboard.php';},1500);</script>";
} catch (Throwable $e) {
