...
<header class="header">
  ...
  <nav class="header__menu" aria-label="Menú principal">
    ...
    <a class="btn btn--ghost" href="../admisiones/dashboard.php">Inicio</a>
...
(function(){
  ...
  const ENDPOINTS = {
    ingreso:         '../admisiones/registrar_ingreso.php',
    salidaAlmuerzo:  '../admisiones/registrar_salida_almuerzo.php',
    regresoAlmuerzo: '../admisiones/registrar_regreso_almuerzo.php',
    salidaLaboral:   '../admisiones/registrar_salida_laboral.php'
  };

  // ✅ Siempre redirige al dashboard TI tras cada registro exitoso
  const REDIR = '../admisiones/dashboard.php';
