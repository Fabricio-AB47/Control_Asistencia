...
if ($latitud === null || $longitud === null || !$direccion) {
    ...
    echo "<script>setTimeout(function(){location.href='../admisiones/dashboard.php';},2000);</script>";
    exit();
}
...
try {
    ...
    if ($idHoraIngreso <= 0) {
        ...
        echo "<script>setTimeout(function(){location.href='../admisiones/dashboard.php';},1500);</script>";
        exit();
    }
