...
<body>
    ...
    <nav class="contenedor-menu">
        <h2>Menú</h2>
            ...
            <a href="../bienestar/dashboard.php">Inicio</a>
            <a href="../bienestar/control.php">Registro de Control Horario</a>
            <a href="../bienestar/reporte_timbres.php">Reporte de timbres</a>
