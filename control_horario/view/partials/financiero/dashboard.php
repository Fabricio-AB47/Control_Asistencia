...
<body>
    ...
    <header class="header">
      ...
      <nav class="header__menu" aria-label="Menú principal">
        ...
        <a class="btn btn--ghost" href="../financiero/dashboard.php">Inicio</a>
        <a class="btn btn--ghost"href="../financiero/control.php">Registro de Control Horario</a>
        <a class="btn btn--ghost" href="../financiero/reporte_timbres.php">Reporte de timbres</a>
